...
/**
 * \file    test/phpunit/Facturation_AdherentsFunctionalTest.php
...
/**
 * Class Facturation_AdherentsFunctionalTest
 *
 ...
 *
 * @package Testfacturation_adherents
 */
class Facturation_AdherentsFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modFacturation_Adherents')->click();
		} else {
			// Disable the module
			$this->byHref('modFacturation_Adherents')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/facturation_adherents/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('facturation_adherents/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/facturation_adherents/admin/about.php');
		$this->authenticate();
		return $this->assertContains('facturation_adherents/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('facturation_adherentswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modFacturation_Adherents_Facturation_AdherentsTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modFacturation_Adherents_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
